...
DEFAULT_MANAGED_ENV_PATH = "/data/control-center.env"
DEFAULT_MANAGED_ENV_VALUES: tuple[tuple[str, str], ...] = (
    ...
    ("MAP_LONGITUDE", ""),
    ("MAP_RADIUS_KM", "0.8"),
    ("PUBLIC_IP_LOCATION_ENABLED", "true"),
    ("OPENCELLID_API_KEY", ""),
    ("ADVANCED_MODEM_MODE", "disabled"),
    ...
    ("DATABASE_PATH", "/data/control-center.db"),
    ("LOG_LEVEL", "INFO"),
    ("CORS_ORIGINS", ""),
)
